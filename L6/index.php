                ...
                <?php while ($row = $consulta->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#eliminaModal" data-bs-id="<?= $row['id_usuario']; ?>"><i class="fa-solid fa-trash"></i></i> Eliminar</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
